    ...
    'lactate-threshold-training': {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "ENDURE is the first cycling app that lets you log lactate readings directly during a ride — or add them afterwards from your activity history. The app fits a curve through your readings and automatically estimates LT1 and LT2, including a confidence tunnel that shows how solid the estimate is. Your blood markers live next to your power data instead of in a spreadsheet, and every new reading refines the picture. Completely free during Early Release, on iOS and Android."
        }
      ],
      ctaTitle: "Log your first lactate test in ENDURE",
      ctaBody: "Free during Early Release on iOS and Android — in-ride lactate logging, automatic LT1/LT2 estimation, and your full training picture in one app.",
